...
/**
 * Auto-generated Recommendation Routes
 *
...
import type { RecommendationHooks } from "./recommendation.hooks"
...
/**
 * Set hooks for Recommendation routes
 */
export function setRecommendationHooks(h: RecommendationHooks) {
  hooks = h
}
...
const WRITABLE_SCALAR_FIELDS = ["userId", "type", "title", "content", "priority", "isRead", "createdAt"] as const
...
/**
 * Create Recommendation CRUD routes
 */
export function createRecommendationRoutes(): Hono {
  ...
  router.get("/", async (c) => {
    try {
      ...
      console.error("[Recommendation] List error:", error)
  ...
  router.get("/:id", async (c) => {
    try {
      ...
      if (!item) {
        return sendJson(c, { error: { code: "not_found", message: "Recommendation not found" } }, 404)
      }
