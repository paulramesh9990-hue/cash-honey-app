...
const WRITABLE_SCALAR_FIELDS = ["email", "name", "createdAt", "updatedAt", "monthlyIncome", "riskTolerance", "currency"] as const
const RELATION_FIELDS = ["accounts", "transactions", "budgets", "goals", "portfolios", "recommendations"] as const
