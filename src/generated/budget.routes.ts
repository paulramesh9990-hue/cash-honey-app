...
const WRITABLE_SCALAR_FIELDS = ["userId", "category", "amount", "spent", "month", "year", "createdAt", "updatedAt"] as const
...
export function createBudgetRoutes(): Hono {
  ...
  router.get("/:id", async (c) => {
    try {
      ...
      if (!item) {
        return sendJson(c, { error: { code: "not_found", message: "Budget not found" } }, 404)
      }
