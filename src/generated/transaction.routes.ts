...
const WRITABLE_SCALAR_FIELDS = ["userId", "accountId", "amount", "type", "category", "description", "date", "createdAt"] as const
...
export function createTransactionRoutes(): Hono {
  ...
  router.get("/:id", async (c) => {
    try {
      ...
      if (!item) {
        return sendJson(c, { error: { code: "not_found", message: "Transaction not found" } }, 404)
      }
