...
/**
 * Hooks for Recommendation routes
 */
export interface RecommendationHooks {
  /**
...
/**
 * Default Recommendation hooks (customize as needed)
 */
export const recommendationHooks: RecommendationHooks = {
