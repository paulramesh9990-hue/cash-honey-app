...
/**
 * Auto-generated Portfolio Routes
 *
...
import type { PortfolioHooks } from "./portfolio.hooks"
...
/**
 * Set hooks for Portfolio routes
 */
export function setPortfolioHooks(h: PortfolioHooks) {
  hooks = h
}
...
const WRITABLE_SCALAR_FIELDS = ["userId", "accountId", "symbol", "name", "quantity", "avgCost", "currentPrice", "createdAt", "updatedAt"] as const
const RELATION_FIELDS = ["user", "account"] as const
 ...
 */
export function createPortfolioRoutes(): Hono {
  ...
  router.get("/:id", async (c) => {
    try {
      ...
      if (!item) {
        return sendJson(c, { error: { code: "not_found", message: "Portfolio not found" } }, 404)
      }
